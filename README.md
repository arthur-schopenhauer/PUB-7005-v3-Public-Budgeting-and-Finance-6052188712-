...
# Instructions
To properly view the chart and its annotations, you must download the file [BarChart.html](https://github.com/arthur-schopenhauer/PUB-7005-v3-Public-Budgeting-and-Finance-6052188712-/blob/main/BarChart.html) above by clicking on the link. Once downloaded open it in a web browser (such as Chrome, Firefox, or Safari).
